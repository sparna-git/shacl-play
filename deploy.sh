scp shacl-play/target/shacl-play-0.9.0.war admin@calliope.sparna.fr:~
...
cp /home/admin/shacl-play-0.9.0.war /var/lib/tomcat8/tomcat8-instance1/webapps/play.war
