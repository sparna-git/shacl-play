# Transfer
scp -i /home/thomas/.ssh/sparna-keypair-francfort.pem shacl-play/target/shacl-play-0.12.4.war ubuntu@92.243.27.145:~
...
cp /home/ubuntu/shacl-play-0.12.4.war /var/lib/tomcat10/webapps/play.war
