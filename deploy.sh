scp shacl-play/target/shacl-play-0.11.2.war admin@calliope.sparna.fr:~
...
# cp /home/admin/shacl-play-0.11.2.war /var/lib/tomcat8/tomcat8-instance1/webapps/play.war
...
cp /home/admin/shacl-play-0.11.2.war /var/lib/tomcat9/webapps/play.war
