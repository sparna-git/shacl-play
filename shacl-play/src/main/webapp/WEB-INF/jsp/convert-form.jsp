			  	...
			  	<form id="upload_form" action="convert" method="POST" enctype="multipart/form-data" class="form-horizontal">
				      ...
				      <div class="form-group row">
					    ...
					    <label for="inputFile" class="col-sm-3 col-form-label">
					    	...
					    	<fmt:message key="convert.inputData.upload" />
					    		...
					    		<div class="fileinput fileinput-new input-group" data-provides="fileinput">
								  ...
								  <span class="input-group-append">
								    <span class="input-group-text fileinput-exists" data-dismiss="fileinput">
								      <fmt:message key="convert.inputData.upload.remove" />
								    </span>
								
								    <span class="input-group-text btn-file">
								      <span class="fileinput-new"><fmt:message key="convert.inputData.upload.select" /></span>
								      <span class="fileinput-exists"><fmt:message key="convert.inputData.upload.change" /></span>
								      <input type="file" name="inputFile" multiple onchange="enabledInput('inputFile')">
								    </span>
								  </span>
								</div>
								<small class="form-text text-muted">
								  <fmt:message key="convert.inputData.upload.help" />
								</small>
					    </div>
					  </div>
					  <div class="form-group row">
					    <label for="inputUrl" class="col-sm-3 col-form-label">
					    	...
					    	<fmt:message key="convert.inputData.url" />
					    </label>
					    <div class="col-sm-9">
					      <input 
					      	type="text"
					      	...
					      	id="inputUrl"
					      	name="inputUrl"
					      	placeholder="<fmt:message key="convert.inputData.url.placeholder" />"
					      	onkeypress="enabledInput('inputUrl');"
					      	onpaste="enabledInput('inputUrl');"
					      />
					      <small class="form-text text-muted">
								  <fmt:message key="convert.inputData.url.help" />
						  </small>
					    </div>
					  </div>
					  <div class="form-group row">
					    <label for="inputInline" class="col-sm-3 col-form-label">
					    	...
					    	<fmt:message key="convert.inputData.inline" />
					    </label>
					    <div class="col-sm-9">
					      <textarea 
					      	class="form-control"
					      ...
					      ></textarea>
					      <small class="form-text text-muted">
								  <fmt:message key="convert.inputData.inline.help" />
						  </small>
					    </div>
					  </div>
					  </blockquote>
						  ...
						  <blockquote class="blockquote bq-primary">		  
						      ...
						      <div class="form-group row">
							    ...
							    <label for="inputShapeFile" class="col-sm-3 col-form-label">
							    	...
							    	<fmt:message key="convert.shapes.upload" />
							    ...
							    <div class="col-sm-9">
							    		<div class="fileinput fileinput-new input-group" data-provides="fileinput">
										  ...
										  <span class="input-group-append">
										    <span class="input-group-text fileinput-exists" data-dismiss="fileinput">
										      <fmt:message key="convert.shapes.upload.remove" />
										    </span>
										
										    <span class="input-group-text btn-file">
										      <span class="fileinput-new"><fmt:message key="convert.shapes.upload.select" /></span>
										      <span class="fileinput-exists"><fmt:message key="convert.shapes.upload.change" /></span>
										      <input type="file" name="inputShapeFile" multiple onchange="enabledShapeInput('inputShapeFile')">
										    </span>
										  </span>
										</div>
										<small class="form-text text-muted">
											  <fmt:message key="convert.shapes.upload.help" />
									  </small>
							    </div>
							  </div>
						      ...
						      <c:if test="${not empty data.catalog.entries}">
							      <div class="form-group row">	
								    <label for="inputShapeCatalog" class="col-sm-3 col-form-label">
								    	...
								    	<fmt:message key="convert.shapes.catalog" />					    
								    </label>
								    <div class="col-sm-9">
										    ...
										    <small class="form-text text-muted">
												  <fmt:message key="convert.shapes.catalog.help" />
										    </small>
								    </div>
								  </div>
							  </c:if>
							  ...
							  <div class="form-group row">
							    <label for="inputShapeUrl" class="col-sm-3 col-form-label">
							    	...
							    	<fmt:message key="convert.shapes.url" />
							    </label>
							    <div class="col-sm-9">
							      <input 
							      	type="text"
							      	...
							      	id="inputShapeUrl"
							      	name="inputShapeUrl"
							      	placeholder="<fmt:message key="convert.shapes.url.placeholder" />"
							      	onkeypress="enabledShapeInput('inputShapeUrl');"
							      	onchange="enabledShapeInput('inputShapeUrl')"
							      >
							      <small class="form-text text-muted">
									  <fmt:message key="convert.shapes.url.help" />
							    </small>
							    </div>
							  </div>
							  <div class="form-group row">
							    <label for="inputShapeInline" class="col-sm-3 col-form-label">
							    	...
							    	<fmt:message key="convert.shapes.inline" />
							    </label>
							    <div class="col-sm-9">
							      <textarea 
							      	class="form-control"
							      ...
							      ></textarea>
							      <small class="form-text text-muted">
									  <fmt:message key="convert.shapes.inline.help" />
								  </small>
							    </div>	
						      </div>
					      </blockquote>
