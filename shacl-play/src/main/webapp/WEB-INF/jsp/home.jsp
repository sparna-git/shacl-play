						...
						<div class="card">
							...
							<div class="card-body bg-light.bg-gradient">								
								...
								<ul style="list-style-type:none;justify-content: flex-start; padding: 0.3rem;">
									...
									<!-- http://localhost:8080/shacl-play/schema 
									<li style="display: list-item; text-align: -webkit-match-parent; padding: 0.3rem;">
										<a href="<c:url value="/schema" />" title="<fmt:message key="navbar.menu1.schema.tooltip" />"><fmt:message key="navbar.menu1.schema.label" /></a> | <small>&nbsp;<a href="<c:url value="/schema#documentation" />" title="documentation"><i class="fal fa-book"></i></a></small>
									</li>
									-->
									<li style="display: list-item; text-align: -webkit-match-parent; padding: 0.3rem;">
