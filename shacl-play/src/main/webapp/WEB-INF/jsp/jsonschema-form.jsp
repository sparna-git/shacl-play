	...
	<div class="container-fluid">
		<div class="row justify-content-md-center">
			<div class="col-6">
				...
				<h1 class="display-3">
					<fmt:message key="schema.title" />
				</h1>

				<div class="form-shortdesc">
					<p>
						This utility <em>generates a <a
							href="https://json-schema.org/">JSON Schema document</a> from a
							SHACL specification
						</em>. Detailed documentation is available <a href="#documentation">below</a>.
					</p>
				</div>

				<form id="upload_form" action="jsonschema" method="POST"
					enctype="multipart/form-data" class="form-horizontal">
					<h2>
						<i class="fal fa-shapes"></i>&nbsp;&nbsp;
						<fmt:message key="schema.shapes.title" />
					</h2>
					...
					<h2>
						...
						<fmt:message key="blockquote.options.title" />
					</h2>

					<!-- URL Root -->
					<blockquote class="blockquote bq-warning">
						<label for="format" class="col-sm-3 col-form-label"> <fmt:message
								key="schema.options.url" />
						</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="IdUrl" name="IdUrl"
								placeholder="<fmt:message key="schema.options.urlRoot.placeholder" />"
								onkeypress="enabledShapeInput('IdUrl');"
								onchange="enabledShapeInput('IdUrl')"> <small
								class="form-text text-muted"> <fmt:message
									key="schema.options.url.help" />
							</small>
						</div>
					</blockquote>
					...
					<blockquote class="blockquote bq-warning">
						...
						<div class="col-sm-4">
							...
							<select id="rootURISNodeShapes" name="rootURISNodeShapes">
								<option value="--Select URI--">Select URI</option>
							...
							<button name="loadNodeShape" id="loadNodeShape"
								class="btn btn-info btn-lg" value="true">
								<fmt:message key="schema.submit" />
							</button>
				...
				<div style="margin-top: 3em;">
					...
					<div style="margin-top: 2em;">
						...
						<p>The algorithm follow these steps to generate the JSON
							Schema:</p>
