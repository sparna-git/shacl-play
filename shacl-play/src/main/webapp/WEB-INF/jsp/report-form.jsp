...
<html>
	<head>
		...
		<link rel="canonical" href="https://shacl-play.sparna.fr/play/report" />
		...
		<div class="container-fluid">
			<div class="row justify-content-md-center">
				<div class="col-6">
					...
					<h1 class="display-3"><fmt:message key="report.title" /></h1>
					
					<div class="form-shortdesc">
						<p>
							This utility <em>generates a .......
						</p>
					</div>
					...
					<div style="margin-top:3em;">
						...
						<div style="margin-top:2em;">
							<h4 id="algorithm">Report of validation SHACL ....................
