			...
			<div class="row justify-content-md-center">
				<div class="col-6">
					...
					<div class="form-shortdesc">
						<p>
							This utility <em>displays an already generated SHACL validation report in a user-friendly format.</em>
							It produces the same output as the <a href="validate">SHACL Play validator form</a>, but from an already generated 
							validation report, which can be generated by any other SHACL validation tool (e.g. <a href="https://jena.apache.org/documentation/shacl/">Jena SHACL</a>)
						</p>
						<p>The same feature is available in <a href="https://github.com/sparna-git/shacl-play/wiki/Run-SHACL-Play-App-from-command-line">SHACL Play command-line utility</a></p>
					</div>
